-- Migração completa do banco de dados Sentra Partners

-- PASSO 1: Atualizar dados existentes
UPDATE users SET role = 'client' WHERE role = 'user';

-- PASSO 2: Atualizar estrutura da tabela users
ALTER TABLE users 
...
-- PASSO 4: Atualizar tabela trading_accounts
...
-- PASSO 5: Atualizar tabela trades
