-- Script compatível com MySQL 8.0 (sem IF NOT EXISTS em ALTER TABLE)
...
ALTER TABLE users ADD COLUMN managerId INT AFTER role;
...
-- 13. Atualizar tabela trading_accounts
...
-- 16. Inserir endereços de pagamento crypto padrão
