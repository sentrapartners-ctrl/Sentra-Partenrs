                    ...
                    return (
                      ...
                      >
                        <div className="flex flex-col h-full justify-between">
                          ...
                          {hasProfit && (
                            <div className={`font-semibold leading-tight text-[10px] sm:text-xs md:text-sm lg:text-xl ${profit > 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
